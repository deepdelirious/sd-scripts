...
def train(args):
    ...
    if accelerator.is_main_process:
        ...
        accelerator.init_trackers("finetuning" if args.log_tracker_name is None else args.log_tracker_name, init_kwargs=init_kwargs, config={k: str(v) for k, v in vars(args).items()})
